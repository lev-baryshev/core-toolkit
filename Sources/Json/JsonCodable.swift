...
public extension JsonDecodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        catch { throw Exception("[Deserializable] unable to deserialize:[\(String(describing: Self.self))]: \(error)") }
    }
...
public extension JsonEncodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        catch { throw Exception("[Serializable] unable to serialize:[\(String(describing: Self.self))]: \(error)") }
    }
